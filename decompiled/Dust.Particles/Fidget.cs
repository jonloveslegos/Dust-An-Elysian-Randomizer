...
namespace Dust.Particles
{
	internal class Fidget : Particle
	{
		...
		public override void Update(float gameTime, Map map, ParticleManager pMan, Character[] c, int l)
		{
			...
			if (c[0].KeyThrow && Game1.stats.canThrow && Game1.stats.playerLifeState == 0 && c[0].StatusEffect != StatusEffects.Silent && ((Game1.stats.upgrade[Game1.stats.projectileType] > 0 && Game1.stats.projectileType != 0 && Game1.stats.projectileType != 3) || (Game1.stats.upgrade[3] > 0 && Game1.stats.projectileType == 0)))
			{
