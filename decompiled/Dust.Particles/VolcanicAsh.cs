...
{
	internal class VolcanicAsh : Particle
	{
		private int origX;
		...
		public VolcanicAsh(Vector2 traj, float size, int type, int layer)
		{
		...
		private void ResetPos(int l)
		{
			...
			if (weatherType == WeatherType.LavaLight)
			{
				num2 /= 2;
			}
		...
		public override void Update(float gameTime, Map map, ParticleManager pMan, Character[] c, int l)
		{
			...
			else
			{
				...
				if (Game1.wManager.weatherType == WeatherType.LavaLight)
				{
		...
		public override void Draw(SpriteBatch sprite, Texture2D[] particlesTex, float worldScale, int l)
		{
			...
			Vector2 vector = base.GameLocation(l);
			Color color = new Color(1f, 1f, 0f, this.alpha);
			if (base.flag == 0)
			{
				...
				Rectangle value = new Rectangle(12, 140, 6, 8);
				sprite.Draw(particlesTex[1], vector, value, color, this.rotation, new Vector2(this.origX, 8f), vector2, SpriteEffects.None, 1f);
				sprite.Draw(particlesTex[1], vector + new Vector2(200f, -100f), value, color, 0f - this.rotation, new Vector2(this.origX, 8f), vector2 / 1.5f, SpriteEffects.None, 1f);
				sprite.Draw(particlesTex[1], vector + new Vector2(150f, 100f), value, color, this.rotation, new Vector2(this.origX, 8f), vector2 / 2f, SpriteEffects.None, 1f);
				return;
			}
